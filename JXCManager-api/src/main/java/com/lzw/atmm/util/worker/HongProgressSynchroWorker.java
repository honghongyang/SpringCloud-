 ...
 * 版权所有：2016-中实智达
 * 项目名称：JXCManager-api   
 * 类描述    ：JohnSwingWorker的单一线程版本,不会得到多线程的任何好处,
 *        但省去了同步的麻烦,主要特色是伴有加载进度界面做为当前任务描述
 * 类名称    ：com.lzw.atmm.util.worker.HongProgressSynchroWorker     
 * 创建人    ：杨洪
 * 创建时间：2016年12月28日 上午9:58:42   
 * 修改人    ：
 * 修改时间：2016年12月28日 上午9:58:42   
 * 修改备注：   
 * @version   V1.0    
 */

public abstract class HongProgressSynchroWorker implements HongWorker{

	/**异常发生时的建议*/
	protected String executionSuggests;
	/**异常信息界面和加载进度界面的父窗口*/
	...
	public HongProgressSynchroWorker(String exceptionSugguests,Window parentWindow,Action continueActionButtun,String taskName){
		this.executionSuggests = exceptionSugguests;
		this.parentWindow = parentWindow;
		this.continueActionButton = continueActionButtun;
